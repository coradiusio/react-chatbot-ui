...
import {useKeyOnly, useValueAndKey, useKeyOrValueAndKey} from '../../lib/classNameBuilders'
...
class Button extends Component {
  ...
  render() {
    ...
    if (!_.isNil(label)) {
      const buttonClasses = cx('react-chatbot-ui', baseClasses, 'button', className)
      const containerClasses = cx('react-chatbot-ui', labeledClasses, 'button', className, wrapperClasses)
    ...
    const classes = cx('react-chatbot-ui', baseClasses, wrapperClasses, labeledClasses, 'button', className)
