...
import {useKeyOnly, useKeyOrValueAndKey, useValueAndKey, useVerticalAlignProp} from '../../lib/classNameBuilders'
import * as SUI from '../../lib/SUI'
import {partitionHTMLProps} from '../../lib/htmlPropsUtils'
...
function Image(props) {
  ...
  const classes = cx(
    useKeyOnly(ui, 'react-chatbot-ui'),
    size,
